...
#include <stdio.h>
int main() {
  unsigned char message[16] = { 59, 233, 130, 151, 201, 43, 164, 180, 62, 26, 78, 207, 198, 25, 54, 175 };
  unsigned char last_key[16] = { 98, 241, 136, 41, 38, 143, 248, 128, 66, 64, 181, 180, 18, 13, 79, 203 };
  
  aes128_otfks_decrypt(message, last_key);
